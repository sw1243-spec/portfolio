...
(function () {
  ...
  const KO = [
    ...
    [".resume section:nth-of-type(3) .timeline-item:nth-child(1) span", "교육부 · 부산라이즈혁신원 · 국립부경대학교 · 2026"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(1) .timeline-text", "국립부경대가 운영한 1박 2일 AI 기반 MVP 구체화 실습 프로그램. 데모데이에서 해외 공장 품질을 원격으로 관리하는 세이원(SAYWON) MVP를 팀과 함께 시연하고 IR 발표."],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(2) .timeline-item-title", "우수상 — AI 활용 경진대회"],
    ...
    [".project-list .project-item:nth-child(6) .project-category", "자동화 — Claude · Codex · 우수상"],
