...
(function () {
  ...
  const KO = [
    ...
    [".resume section:nth-of-type(3) .timeline-item:nth-child(1) .timeline-item-title", "우수상 — AI Startup Studio"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(1) span", "교육부 · 부산라이즈혁신원 · 2026"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(1) .timeline-text", "1박 2일 AI 기반 MVP 구체화 실습 프로그램. 1인 팀으로 참가해 데모데이에서 해외 공장 품질을 원격으로 관리하는 세이원(SAYWON) MVP를 시연하고 IR 발표."],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(2) .timeline-item-title", "최우수상 — AI 활용 경진대회"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(2) span", "Hansae Mobility · 2026"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(2) .timeline-text", "전사 대회 — 현장 자동화를 위한 AI 활용 표준 개발 파이프라인."],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(3) .timeline-item-title", "1위 (First Prize) — BITLO"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(3) span", "부산연구원 · 부산항만공사 · 2024"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(3) .timeline-text", "부산국제무역물류전 — 도시 물류 혁신의 실현 가능성과 창의성을 인정받음."],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(4) .timeline-item-title", "Best Debater & Best Project"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(4) span", "동원그룹 인재육성 프로그램 · 2023"],
    [".resume section:nth-of-type(3) .timeline-item:nth-child(4) .timeline-text", "기업 인재육성 프로그램에서 팀 케이스 프로젝트 2건과 임원 발표를 리드."],
    ...
    [".project-list .project-item:nth-child(6) .project-highlights li:nth-child(2)", "사내 AI 활용 경진대회 최우수상 수상"],
    ...
    [".filter-list .filter-item:nth-child(4) button", "자동화"],
    [".filter-list .filter-item:nth-child(5) button", "데이터 분석"],
    ...
    [".select-list .select-item:nth-child(4) button", "자동화"],
    [".select-list .select-item:nth-child(5) button", "데이터 분석"],
    ...
    [".project-list .project-item:nth-child(4) .project-category", "자동화 — Excel · VBA"],
    [".project-list .project-item:nth-child(5) .project-category", "데이터 분석 — SQL · ERD"],
    [".project-list .project-item:nth-child(6) .project-category", "자동화 — Claude · Codex · 최우수상"],
    [".project-list .project-item:nth-child(7) .project-category", "데이터 분석 — Python · GeoPandas · scikit-learn"],
    [".project-list .project-item:nth-child(8) .project-category", "데이터 분석 — Python · 부산 데이터 오픈랩"],
